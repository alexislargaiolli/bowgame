...
public class BowGame {
	...
	public void loadResources() {
		...
		assets.load(ArrowManager.arrowTextureName, Texture.class);
	...
	public void init() {
		...
		player = new Player(40, 200, new TextureRegion(assets.get("block2.png", Texture.class)));
		player.setBow(bow);
	}

	public void draw(float delta) {
		background.render(loose ? 0 : delta);
